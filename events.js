...
module.exports = (client, Discord, mes, ee) => {
    ...
    client.on("ready", () => {
        ...
        setInterval(async () => {
            for (const guild of client.guilds.cache.array()) {
                ...
                let txtchannel = guild.channels.cache.find(
                    channel =>
                        channel.type === "text" &&
        ...
        if (cmd == "help") {
            message.channel.send(
                new MessageEmbed()
                    ...
                    .setDescription(`Follow this to Control me ...\n 1.${prefix}setup\n This command added a Song \n 2.${prefix}join\n Join A Voice Channel..\n 3.${prefix}rejoin\n Re Join a Voice Channel......\n 4.${prefix}stop\n Lave a Voice Channel......`)
